import type { AgentRecord, AttemptRecord, FieldExamRecord } from "./contracts";
import { canonicalize, sha256, signPayload } from "./crypto";

export interface ToolMasteryCredential {
  schema: "https://raw.githubusercontent.com/BrandonDucar/toolgym/main/schemas/agent-tool-mastery-credential-v0.1.schema.json";
  id: string;
  ...
  credentialSubject: {
    ...
    achievement: {
      ...
      criteriaVersion: "toolgym-core-1.0.0";
    };
  };
  evidence: {
